// CMS_Frontend_v6 — 語系切換（vanilla，無框架、無 build）。
...
//     cms-v6:locale-changed 監聽(見 site.js)。
(function () {
  'use strict';

  var LOCALE_KEY = 'cms-v6:locale';
  ...
  /* 設計後台(studio)可關閉部分語言,不讓玩家在前台切換到;跟 studio.js
     ...
     設定內容無效時落回這份預設清單。 */
  var STUDIO_LOCALES_KEY = 'cms-v6-studio-locales';
  ...
  var STRINGS = {
    ...
    'footer.copyright': {
      zh: '© 2026 APEX100 版權所有，受法律保護。本站僅供介面展示，不涉及任何實際投注行為。',
      en: '© 2026 APEX100. All rights reserved. This site is for interface demonstration purposes only and does not involve any real wagering.',
      ko: '© 2026 APEX100. 모든 권리 보유. 본 사이트는 인터페이스 시연 용도로만 제공되며, 실제 베팅 행위와는 무관합니다.',
      th: '© 2026 APEX100 สงวนสิทธิ์ทุกประการ เว็บไซต์นี้ใช้เพื่อสาธิตอินเทอร์เฟซเท่านั้น ไม่มีการพนันจริงเกิดขึ้น',
    },
    ...
    'faq.q1': { zh: '什麼是 APEX100？', en: 'What is APEX100?', ko: 'APEX100이란 무엇인가요?', th: 'APEX100 คืออะไร?' },
    'faq.a1': { zh: 'APEX100 是一個提供可信賴、經驗證遊戲的海外投注網站，涵蓋體育、老虎機、真人娛樂、電子遊戲、捕魚達人等多元遊戲類型。', en: 'APEX100 is an offshore betting site offering trusted, verified games covering sports, slots, live casino, electronic games, fishing, and more.', ko: 'APEX100은 스포츠, 슬롯, 라이브 카지노, 전자 게임, 낚시 게임 등 다양한 게임을 제공하는 신뢰할 수 있는 해외 베팅 사이트입니다.', th: 'APEX100 เป็นเว็บพนันต่างประเทศที่นำเสนอเกมที่น่าเชื่อถือและได้รับการตรวจสอบ ครอบคลุมกีฬา สล็อต คาสิโนสด เกมอิเล็กทรอนิกส์ และยิงปลา' },
    'faq.q2': { zh: '遊戲結果公平嗎？', en: 'Are the game results fair?', ko: '게임 결과는 공정한가요?', th: 'ผลเกมยุติธรรมหรือไม่?' },
    'faq.a2': { zh: 'APEX100 是合法註冊的公司，所有遊戲結果皆採用公平驗證機制，確保每一局結果不受人為操縱。', en: 'APEX100 is a legally registered company; all game results use a fair verification mechanism to ensure no manipulation.', ko: 'APEX100은 합법적으로 등록된 회사이며, 모든 게임 결과는 공정성 검증 메커니즘을 통해 조작되지 않도록 보장됩니다.', th: 'APEX100 เป็นบริษัทที่จดทะเบียนอย่างถูกกฎหมาย ผลเกมทั้งหมดใช้กลไกตรวจสอบความยุติธรรมเพื่อป้องกันการควบคุมผลลัพธ์' },
    'faq.q3': { zh: '我的個人資訊安全嗎？', en: 'Is my personal information safe?', ko: '개인 정보는 안전한가요?', th: 'ข้อมูลส่วนตัวของฉันปลอดภัยหรือไม่?' },
    'faq.a3': { zh: '我們高度重視您的個人資訊安全，APEX100 絕不會將您的資料提供予未經授權的第三方。', en: 'We take your personal information security very seriously; APEX100 will never provide your data to unauthorized third parties.', ko: '고객님의 개인정보 보안을 매우 중요하게 생각하며, APEX100은 승인되지 않은 제3자에게 절대 정보를 제공하지 않습니다.', th: 'เราให้ความสำคัญกับความปลอดภัยของข้อมูลส่วนตัวของคุณอย่างสูงสุด APEX100 จะไม่ให้ข้อมูลของคุณแก่บุคคลที่สามที่ไม่ได้รับอนุญาตเด็ดขาด' },
    ...
    'hero.clubEyebrow': { zh: '會員專屬', en: 'Members Only', ko: '회원 전용', th: 'สำหรับสมาชิกเท่านั้น' },
    'hero.clubTitle': { zh: '加入 APEX100 獎勵俱樂部', en: 'Join the APEX100 Rewards Club', ko: 'APEX100 리워드 클럽 가입', th: 'เข้าร่วม APEX100 Rewards Club' },
    ...
    'ticker.depositLabel': { zh: '存款', en: 'deposit', ko: '입금', th: 'ฝาก' },
  ...
  function applyLocale() {
    ...
    document.dispatchEvent(new CustomEvent('cms-v6:locale-changed', { detail: { locale: locale } }));
  }
